...
class DjangoCache(BaseCache):
    ...
    def add(self, key, value, timeout=..., version=..., read=..., tag=..., retry=...): # -> bool:
    ...
    def get(self, key, default=..., version=..., read=..., expire_time=..., tag=..., retry=...): # -> tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | Any | None:
    ...
    def read(self, key, version=...): # -> tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | Any | None:
    ...
    def set(self, key, value, timeout=..., version=..., read=..., tag=..., retry=...): # -> bool:
    ...
    def pop(self, key, default=..., version=..., expire_time=..., tag=..., retry=...): # -> tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | Any | None:
    ...
    def incr(self, key, delta=..., version=..., default=..., retry=...): # -> int | Any | None:
    ...
    def decr(self, key, delta=..., version=..., default=..., retry=...): # -> int | Any | None:
    ...
    def memoize(self, name=..., timeout=..., version=..., typed=..., tag=..., ignore=...): # -> Callable[..., _Wrapped[..., Any, ..., Any | tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | None]]:
